...
async function seed() {
  ...
  const newsData = [
    ...
    { title: 'RASOC Annual Report 2025 Published', slug: 'rasoc-annual-report-2025', date: daysAgo(30), category: 'Announcement' as const, excerpt: 'RASOC has published its 2025 annual report, providing an overview of its oversight activities and recommendations for the standard-setting boards.', body: richText('The Regulatory and Accounting Standards Oversight Council has published its 2025 annual report.', 'The report provides an overview of RASOC\'s oversight activities during the year and includes recommendations for the standard-setting boards.'), board: boards.rasoc },
    { title: 'PSAB Seeks Volunteers for Revenue Project Advisory Committee', slug: 'psab-volunteers-revenue', date: daysAgo(7), category: 'Announcement' as const, excerpt: 'PSAB is seeking volunteers to serve on the advisory committee for its Revenue project (PS 3400). Applications are due by April 30, 2026.', body: richText('The Public Sector Accounting Board is seeking volunteers to serve on the advisory committee for its revenue recognition project.', 'Committee members will provide input on the development of the new revenue standard.'), board: boards.psab },
    { title: 'AcSB Meeting Summary — February 2026', slug: 'acsb-meeting-feb-2026', date: daysAgo(35), category: 'Update' as const, excerpt: 'Summary of key decisions from the February 2026 AcSB meeting, including discussion of the crypto assets project and NFP improvements.', body: richText('The Accounting Standards Board met on February 24-25, 2026.'), board: boards.acsb },
    { title: 'FRAS Canada Strategic Plan 2027-2030 Consultation', slug: 'fras-strategic-plan', date: daysAgo(12), category: 'Announcement' as const, excerpt: 'FRAS Canada is developing its strategic plan for 2027-2030 and invites stakeholder input on priorities for the standard-setting boards.', body: richText('FRAS Canada is seeking stakeholder input as it develops its strategic plan for the 2027-2030 period.'), board: boards.acsb },
  ...
  const eventsData = [
    ...
    { title: 'Comment Deadline: Exposure Draft — Crypto Assets', slug: 'deadline-crypto-assets', date: daysFromNow(45), type: 'Deadline' as const, description: 'Deadline for submitting comments on the AcSB exposure draft on accounting for crypto assets under ASPE.', board: boards.acsb },
